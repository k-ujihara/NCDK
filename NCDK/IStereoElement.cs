...
namespace NCDK
{
    ...
    public interface IStereoElement<out F, C>
        : IReadOnlyStereoElement<F, C>
        where F : IChemObject
        where C : IChemObject
    {
        /// <summary>
        ...
        /// </summary>
        IList<C> Carriers { get; }
    }

    public interface IReadOnlyStereoElement<out F, out C>
        : IStereoElement
        where F : IChemObject
    {
        /// <summary>
        ...
        /// The carriers of the stereochemistry
        /// </summary>
        IReadOnlyList<C> ReadOnlyCarriers { get; }
    ...
    public partial class StereoElement
    {
        /// <summary>
