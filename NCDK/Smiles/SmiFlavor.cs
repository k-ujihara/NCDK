...
namespace NCDK.Smiles
{
    ...
    public static class SmiFlavor
    {
        ...
        /// <summary>
        /// Output atom values, atom values are specified by <see cref="IPseudoAtom.GetLabel()"/>.
        /// </summary>
        public const int CxAtomValue = 0x010000;

        /// <summary>
        /// Output radicals, radicals are specified by <see cref="IAtomContainer.GetConnectedSingleElectronsCount(IAtom)"/>
        /// </summary>
