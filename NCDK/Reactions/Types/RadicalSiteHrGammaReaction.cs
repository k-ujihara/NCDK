...
namespace NCDK.Reactions.Types
{
    ...
    // @cdk.module     reaction
    // @cdk.githash
    public partial class RadicalSiteHrGammaReaction : AbstractRadicalSiteReaction
    {
        /// <summary>
        ...
        {
            return base.Initiate(reactants, agents, 4, false, atom => atom.AtomicNumber.Equals(NaturalElements.H.AtomicNumber));
        }
    }
}
