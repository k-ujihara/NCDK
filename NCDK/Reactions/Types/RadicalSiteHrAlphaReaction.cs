...
namespace NCDK.Reactions.Types
{
    ...
    // @cdk.module     reaction
    // @cdk.githash
    public partial class RadicalSiteHrAlphaReaction : AbstractRadicalSiteReaction
    {
        /// <summary>
        ...
        {
            return base.Initiate(reactants, agents, 2, false, atom => atom.AtomicNumber.Equals(NaturalElements.H.AtomicNumber));
        }
    }
}
