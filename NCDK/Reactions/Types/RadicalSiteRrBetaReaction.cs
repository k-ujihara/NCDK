...
namespace NCDK.Reactions.Types
{
    ...
    public class RadicalSiteRrBetaReaction : ReactionEngine, IReactionProcess
    {
        /// <summary>
        ...
        public ReactionSpecification Specification =>
            new ReactionSpecification(
                    "http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#RadicalSiteRrBeta", this
        ...
        {
            Debug.WriteLine("initiate reaction: RadicalSiteRrBetaReaction");
            ...
            foreach (var atomi in reactant.Atoms)
            {
                if (atomi.IsReactiveCenter && reactant.GetConnectedSingleElectrons(atomi).Count() == 1)
                {
                    ...
                    var atom1s = hcg.GetNodesInSphere(2);
