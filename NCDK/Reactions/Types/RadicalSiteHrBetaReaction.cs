...
namespace NCDK.Reactions.Types
{
    ...
    // @cdk.module     reaction
    // @cdk.githash
    public partial class RadicalSiteHrBetaReaction : AbstractRadicalSiteReaction
    {
        /// <summary>
        ...
        {
            return base.Initiate(reactants, agents, 3, false, atom => atom.AtomicNumber.Equals(ChemicalElement.AtomicNumbers.H));
        }
    }
}
