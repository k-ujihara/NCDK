...
{
    /// <summary>
    /// <para>IReactionProcess which make an electron impact for É–-Bond Dissociation.</para>
    ...
    // @cdk.module     reaction
    // @cdk.githash
    public partial class ElectronImpactSDBReaction : AbstractElectronImpactDBReaction
    {
