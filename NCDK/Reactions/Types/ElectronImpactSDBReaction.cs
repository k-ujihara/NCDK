...
{
    /// <summary>
    /// <para>IReactionProcess which make an electron impact for Sigma Bond Dissociation.</para>
    /// </summary>
    ...
    public class ElectronImpactSDBReaction : ReactionEngine, IReactionProcess
    {
        /// <summary>
        ...
        public ReactionSpecification Specification =>
            new ReactionSpecification(
                    "http://almost.cubic.uni-koeln.de/jrg/Members/mrc/reactionDict/reactionDict#ElectronImpactSDB", this
        ...
        {
            Debug.WriteLine("initiate reaction: ElectronImpactSDBReaction");
