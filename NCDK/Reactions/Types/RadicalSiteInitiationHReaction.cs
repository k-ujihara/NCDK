...
namespace NCDK.Reactions.Types
{
    ...
    /// for each atom. You can use the method: <see cref="LonePairElectronChecker"/></para>
    ...
    public class RadicalSiteInitiationHReaction : ReactionEngine, IReactionProcess
    {
        /// <summary>
        ...
        {
            Debug.WriteLine("initiate reaction: RadicalSiteInitiationHReaction");
