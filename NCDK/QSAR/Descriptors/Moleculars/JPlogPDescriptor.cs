...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class JPlogPDescriptor : AbstractDescriptor, IMolecularDescriptor
    {
        ...
        /// </summary>
        private static readonly IReadOnlyDictionary<int, double> defaultCoeffs = WeightsCurr;
        ...
        public static readonly IReadOnlyDictionary<int, double> WeightsPlante2018 = new Dictionary<int, double>
        {
