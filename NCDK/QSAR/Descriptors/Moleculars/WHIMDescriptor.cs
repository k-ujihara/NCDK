...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class WHIMDescriptor : AbstractMolecularDescriptor, IMolecularDescriptor
    {
        ...
        public WHIMDescriptor()
        {
            ...
            {
                [NaturalElement.AtomicNumbers.H] = 0.084,
                [NaturalElement.AtomicNumbers.B] = 0.900,
                [NaturalElement.AtomicNumbers.C] = 1.000,
                [NaturalElement.AtomicNumbers.N] = 1.166,
                [NaturalElement.AtomicNumbers.O] = 1.332,
                [NaturalElement.AtomicNumbers.F] = 1.582,
                [NaturalElement.AtomicNumbers.Al] = 2.246,
                [NaturalElement.AtomicNumbers.Si] = 2.339,
                [NaturalElement.AtomicNumbers.P] = 2.579,
                [NaturalElement.AtomicNumbers.S] = 2.670,
                [NaturalElement.AtomicNumbers.Cl] = 2.952,
                [NaturalElement.AtomicNumbers.Fe] = 4.650,
                [NaturalElement.AtomicNumbers.Co] = 4.907,
                [NaturalElement.AtomicNumbers.Ni] = 4.887,
                [NaturalElement.AtomicNumbers.Cu] = 5.291,
                [NaturalElement.AtomicNumbers.Zn] = 5.445,
                [NaturalElement.AtomicNumbers.Br] = 6.653,
                [NaturalElement.AtomicNumbers.Sn] = 9.884,
                [NaturalElement.AtomicNumbers.I] = 10.566,
            };

            this.hashvdw = new Dictionary<int, double>
            {
                [NaturalElement.AtomicNumbers.H] = 0.299,
                [NaturalElement.AtomicNumbers.B] = 0.796,
                [NaturalElement.AtomicNumbers.C] = 1.000,
                [NaturalElement.AtomicNumbers.N] = 0.695,
                [NaturalElement.AtomicNumbers.O] = 0.512,
                [NaturalElement.AtomicNumbers.F] = 0.410,
                [NaturalElement.AtomicNumbers.Al] = 1.626,
                [NaturalElement.AtomicNumbers.Si] = 1.424,
                [NaturalElement.AtomicNumbers.P] = 1.181,
                [NaturalElement.AtomicNumbers.S] = 1.088,
                [NaturalElement.AtomicNumbers.Cl] = 1.035,
                [NaturalElement.AtomicNumbers.Fe] = 1.829,
                [NaturalElement.AtomicNumbers.Co] = 1.561,
                [NaturalElement.AtomicNumbers.Ni] = 0.764,
                [NaturalElement.AtomicNumbers.Cu] = 0.512,
                [NaturalElement.AtomicNumbers.Zn] = 1.708,
                [NaturalElement.AtomicNumbers.Br] = 1.384,
                [NaturalElement.AtomicNumbers.Sn] = 2.042,
                [NaturalElement.AtomicNumbers.I] = 1.728,
            };

            this.hasheneg = new Dictionary<int, double>
            {
                [NaturalElement.AtomicNumbers.H] = 0.944,
                [NaturalElement.AtomicNumbers.B] = 0.828,
                [NaturalElement.AtomicNumbers.C] = 1.000,
                [NaturalElement.AtomicNumbers.N] = 1.163,
                [NaturalElement.AtomicNumbers.O] = 1.331,
                [NaturalElement.AtomicNumbers.F] = 1.457,
                [NaturalElement.AtomicNumbers.Al] = 0.624,
                [NaturalElement.AtomicNumbers.Si] = 0.779,
                [NaturalElement.AtomicNumbers.P] = 0.916,
                [NaturalElement.AtomicNumbers.S] = 1.077,
                [NaturalElement.AtomicNumbers.Cl] = 1.265,
                [NaturalElement.AtomicNumbers.Fe] = 0.728,
                [NaturalElement.AtomicNumbers.Co] = 0.728,
                [NaturalElement.AtomicNumbers.Ni] = 0.728,
                [NaturalElement.AtomicNumbers.Cu] = 0.740,
                [NaturalElement.AtomicNumbers.Zn] = 0.810,
                [NaturalElement.AtomicNumbers.Br] = 1.172,
                [NaturalElement.AtomicNumbers.Sn] = 0.837,
                [NaturalElement.AtomicNumbers.I] = 1.012,
            };

            this.hashpol = new Dictionary<int, double>
            {
                [NaturalElement.AtomicNumbers.H] = 0.379,
                [NaturalElement.AtomicNumbers.B] = 1.722,
                [NaturalElement.AtomicNumbers.C] = 1.000,
                [NaturalElement.AtomicNumbers.N] = 0.625,
                [NaturalElement.AtomicNumbers.O] = 0.456,
                [NaturalElement.AtomicNumbers.F] = 0.316,
                [NaturalElement.AtomicNumbers.Al] = 3.864,
                [NaturalElement.AtomicNumbers.Si] = 3.057,
                [NaturalElement.AtomicNumbers.P] = 2.063,
                [NaturalElement.AtomicNumbers.S] = 1.648,
                [NaturalElement.AtomicNumbers.Cl] = 1.239,
                [NaturalElement.AtomicNumbers.Fe] = 4.773,
                [NaturalElement.AtomicNumbers.Co] = 4.261,
                [NaturalElement.AtomicNumbers.Ni] = 3.864,
                [NaturalElement.AtomicNumbers.Cu] = 3.466,
                [NaturalElement.AtomicNumbers.Zn] = 4.034,
                [NaturalElement.AtomicNumbers.Br] = 1.733,
                [NaturalElement.AtomicNumbers.Sn] = 4.375,
                [NaturalElement.AtomicNumbers.I] = 3.040,
            };
        }
