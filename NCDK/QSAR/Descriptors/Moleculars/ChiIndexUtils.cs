...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    internal class ChiIndexUtils
    {
        ...
        protected internal static double DeltavSulphur(IAtom atom, IAtomContainer atomContainer)
        {
            ...
            {
                if (connectedAtom.AtomicNumber.Equals(NaturalElements.S.AtomicNumber)
            ...
            foreach (var connectedAtom in connected)
            {
                if (connectedAtom.AtomicNumber.Equals(NaturalElements.O.AtomicNumber)
        ...
        {
            if (!atom.AtomicNumber.Equals(NaturalElements.P.AtomicNumber))
                return -1;
