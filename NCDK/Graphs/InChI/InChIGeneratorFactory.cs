...
namespace NCDK.Graphs.InChI
{
    ...
    public class InChIGeneratorFactory
    {
        ...
        /// generated by this method, please use <see cref="GetInChIGenerator(IAtomContainer, IList{InChIOption})"/>
        ...
        /// <returns>the InChI generator object</returns>
        /// <exception cref="CDKException">if the generator cannot be instantiated</exception>
        public InChIGenerator GetInChIGenerator(IAtomContainer container, IList<InChIOption> options)
        {
            if (options == null)
