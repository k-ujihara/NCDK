...
namespace NCDK.IO
{
    ...
    public class PDBReader : DefaultChemObjectReader
    {
         ...
         * Stream.
         *
         * @param oIn  The Stream to read from
         *
         */
         ...
         * shorter than 59 characters, a <code>ApplicationException</code> is thrown.
         *
         * @param cLine  the PDB ATOM or HEATATM record.
         * @return the <code>Atom</code> created from the record.
         * @ if the line is too short (less than 59 characters).
         */
        ...
        private void ReadHetDictionary()
        {
            try
            {
                Stream ins = GetType().Assembly.GetManifestResourceStream(hetDictionaryPath);
...
//                    try
//                    {
//                        pdbFactory = AtomTypeFactory.GetInstance("NCDK.Config.Data.pdb_atomtypes.xml",
//                                ((IChemFile)oObj).Builder);
//                    }
//                    catch (Exception exception)
//                    {
//                        Debug.WriteLine(exception);
...
//                        // check the first column to decide what to do
//                        cCol = cRead.Substring(0, 6);
//                        if (string.Equals("SEQRES", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            isProteinStructure = true;
//                        }
//                        else if (string.Equals("ATOM  ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            // read an atom record
//                            oAtom = ReadAtom(cRead, lineLength);
...
//                             * they are dealt with seperately.*/
//                        }
//                        else if (string.Equals("HETATM", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            // read an atom record
//                            oAtom = ReadAtom(cRead, lineLength);
//                            oAtom.HetAtom = true;
...
//                            Debug.WriteLine("Added HETATM: ", oAtom);
//                        }
//                        else if (string.Equals("TER   ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            // start new strand
//                            chain++;
//                            oStrand = new PDBStrand();
...
//                            Debug.WriteLine("Added new STRAND");
//                        }
//                        else if (string.Equals("END   ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            atomNumberMap.Clear();
//                            if (isProteinStructure)
//                            {
...
//                            }
//                        }
//                        else if (string.Equals("REMARK", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            var comment = oFile.GetProperty<string>(CDKPropertyName.COMMENT, "");
//                            if (lineLength > 12)
//                            {
...
//                            }
//                        }
//                        else if (string.Equals("COMPND", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            string title = cRead.Substring(10).Trim();
//                            oFile.SetProperty(CDKPropertyName.TITLE, title);
//                        }
...
//                         * should be dealt with in the same way..?
//                         */
//                        else if (readConnect.IsSet && string.Equals("CONECT", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            cRead.Trim();
//                            if (cRead.Length < 16)
//                            {
...
//                        else if (string.Equals("HELIX ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            //						HELIX    1 H1A CYS A   11  LYS A   18  1 RESIDUE 18 HAS POSITIVE PHI    1D66  72
//                            //						          1         2         3         4         5         6         7
//                            //						01234567890123456789012345678901234567890123456789012345678901234567890123456789
...
//                            oBP.Add(structure);
//                        }
//                        else if (string.Equals("SHEET ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            PDBStructure structure = new PDBStructure();
//                            structure.StructureType = PDBStructure.SHEET;
//                            structure.StartChainID = cRead[21];
...
//                            oBP.Add(structure);
//                        }
//                        else if (string.Equals("TURN  ", cCol, StringComparison.OrdinalIgnoreCase))
//                        {
//                            PDBStructure structure = new PDBStructure();
//                            structure.StructureType = PDBStructure.TURN;
//                            structure.StartChainID = cRead[19];
