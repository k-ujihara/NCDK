...
namespace NCDK.IO.Formats
{
    ...
    public class ChemDrawFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "ChemDraw eXchange file";

        /// <inheritdoc/>
        public override string MIMEType => "chemical/x-cdx";

        /// <inheritdoc/>
        public override string PreferredNameExtension => NameExtensions[0];

        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "cdx" };
