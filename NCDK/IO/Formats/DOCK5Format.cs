...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class DOCK5Format : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Dock 5 Box";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "bgf" };
