...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class SDFFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "MDL Structure-data file";

        /// <inheritdoc/>
        public override string MIMEType => "chemical/x-mdl-sdfile";
