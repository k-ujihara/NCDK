...
namespace NCDK.IO.Formats
{
    ...
    public class ADFFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "ADF";
        ...
        {
            if (line.Contains("Amsterdam Density Functional", StringComparison.Ordinal))
            {
                return true;
            }
            return false;
