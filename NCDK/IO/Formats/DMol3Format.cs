...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class DMol3Format : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "DMol3";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "dmol" };
