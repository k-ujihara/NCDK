...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class PMPFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "PolyMorph Predictor (Cerius)";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "pmp" };

        /// <inheritdoc/>
        public override string ReaderClassName { get; } = typeof(PMPReader).FullName;
