...
namespace NCDK.IO.Formats
{
    ...
    public class DaltonFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Dalton";
        ...
        {
            if (line.Contains("DALTON", StringComparison.Ordinal))
            {
                return true;
            }
            return false;
