...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class MacroModelFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string MIMEType => "chemical/x-macromodel-input";

        /// <inheritdoc/>
        public override string PreferredNameExtension => NameExtensions[0];

        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "mmd", "mmod" };
