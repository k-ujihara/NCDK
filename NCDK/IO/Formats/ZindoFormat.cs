...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class ZindoFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Zindo";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "zin" };
