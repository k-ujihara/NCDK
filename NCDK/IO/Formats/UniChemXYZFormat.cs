...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class UniChemXYZFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "UniChemXYZ";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "unixyz" };
