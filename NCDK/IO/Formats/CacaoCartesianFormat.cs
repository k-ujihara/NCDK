...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class CacaoCartesianFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Cacao Cartesian";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "caccrt" };
