...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class PubChemASNFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "PubChem Compound ASN";
        ...
        /// <inheritdoc/>
        public override string ReaderClassName { get; } = typeof(PCCompoundASNReader).FullName;
