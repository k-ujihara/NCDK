...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class SMILESFIXFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "SMILES FIX";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "fix" };
