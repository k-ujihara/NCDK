...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class FingerprintFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Fingerprint";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "fpt" };
