...
namespace NCDK.IO.Formats
{
    ...
    public class MOPAC97Format : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "MOPAC 97";
        ...
        /// <inheritdoc/>
        public override bool Matches(int lineNumber, string line) => line.ContainsOrdinal("MOPAC  97.");
