...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class GROMOS96Format : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "GROMOS96";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "gr96 " };
