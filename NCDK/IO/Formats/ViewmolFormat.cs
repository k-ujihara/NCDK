...
namespace NCDK.IO.Formats
{
    ...
    // @cdk.githash
    public class ViewmolFormat : AbstractResourceFormat, IChemFormat
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "Viewmol";
        ...
        /// <inheritdoc/>
        public override IReadOnlyList<string> NameExtensions { get; } = new string[] { "vmol" };
