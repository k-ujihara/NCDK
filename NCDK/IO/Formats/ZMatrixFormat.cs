...
namespace NCDK.IO.Formats
{
    ...
    public class ZMatrixFormat : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "ZMatrix";
        ...
        /// <inheritdoc/>
        public override string ReaderClassName { get; } = typeof(ZMatrixReader).FullName;
        ...
        {
            if (lineNumber == 4 && line.ContainsOrdinal("Z Matrix"))
            {
                return true;
            }
            return false;
