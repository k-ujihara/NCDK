...
namespace NCDK.IO.Formats
{
    ...
    public class MOPAC7Format : SimpleChemFormatMatcher, IChemFormatMatcher
    {
        ...
        /// <inheritdoc/>
        public override string FormatName => "MOPAC7";
        ...
        /// <inheritdoc/>
        public override bool Matches(int lineNumber, string line) => line.Contains("MOPAC:  VERSION  7.00", StringComparison.Ordinal);
