...
namespace NCDK.Formula
{
    ...
    public class MolecularFormulaGenerator
    {
        ...
        /// <summary>
        /// Generates a <see cref="IMolecularFormulaSet"/> by repeatedly calling <see cref="GetNextFormula"/> 
        ...
        /// </summary>
        /// <remarks>
        /// Note: if some formulas were already generated by calling <see cref="GetNextFormula"/> 
        ...
        /// the first call to <see cref="GetNextFormula"/>, this method returns 0. After
        ...
        /// another thread is executing the <see cref="GetNextFormula"/> method, that
