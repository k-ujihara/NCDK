...
namespace NCDK.Config
{
    ...
    public sealed partial class ChemicalElement
	{
        ...
        /// </summary>
        internal static readonly IDictionary<string, ChemicalElement> symbolMap = new Dictionary<string, ChemicalElement>()
        {
        ...
        /// </summary>
        public static IReadOnlyList<ChemicalElement> Values { get; } = new ChemicalElement[] 
        {
            ChemicalElements.Unknown,
