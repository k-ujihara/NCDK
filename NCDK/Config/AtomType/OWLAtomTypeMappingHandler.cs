...
namespace NCDK.Config.AtomType
{
    ...
    {
        private IDictionary<string, string> atomTypeMappings;
        ...
        /// <summary>
        /// Returns a <see cref="IDictionary{T, T}"/> with atom type mappings.
        /// </summary>
        /// <returns>a <see cref="IDictionary{T, T}"/> with the atom type name of the source schema as key, and the atom type name of the target schema as values.</returns>
