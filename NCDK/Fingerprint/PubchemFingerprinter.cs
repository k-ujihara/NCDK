...
namespace NCDK.Fingerprint
{
    ...
    class PubchemFingerprinter : IFingerprinter
    {
        ...
        public IBitFingerprint GetBitFingerprint(IAtomContainer atomContainer)
        {
            ...
            BitArray fp = new BitArray(FP_SIZE);
        ...
        public static BitArray Decode(string enc)
        {
            ...
            BitArray ret = new BitArray(FP_SIZE);
            for (int i = 0; i < FP_SIZE; i++)
            {
        ...
        static readonly int[] BITCOUNT = new int[] {0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4, 1, 2, 2, 3, 2, 3, 3, 4, 2, 3, 3, 4,
