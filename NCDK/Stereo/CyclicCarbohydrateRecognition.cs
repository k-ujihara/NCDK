    ...
    internal sealed class CyclicCarbohydrateRecognition
    {
        ...
        private class WoundProjection
        {
            ...
            static WoundProjection()
            {
                ...
                // Haworth |V| = 5
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left), HaworthAnticlockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right), HaworthClockwise);

                // Haworth |V| = 6
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left), HaworthAnticlockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right), HaworthClockwise);

                // Haworth |V| = 7
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Left), HaworthAnticlockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Right), HaworthClockwise);

                // Chair
                map.Add(new Key(Turn.Left, Turn.Right, Turn.Right, Turn.Left, Turn.Right, Turn.Right), ChairClockwise);
                map.Add(new Key(Turn.Right, Turn.Left, Turn.Right, Turn.Right, Turn.Left, Turn.Right), ChairClockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Left, Turn.Right, Turn.Right, Turn.Left), ChairClockwise);
                map.Add(new Key(Turn.Right, Turn.Left, Turn.Left, Turn.Right, Turn.Left, Turn.Left), ChairAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Right, Turn.Left, Turn.Left, Turn.Right, Turn.Left), ChairAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Right, Turn.Left, Turn.Left, Turn.Right), ChairAnticlockwise);

                // Boat
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Left, Turn.Left, Turn.Left, Turn.Left), BoatAnticlockwise);
                map.Add(new Key(Turn.Right, Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Right), BoatAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Left, Turn.Left, Turn.Right, Turn.Right), BoatAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Left, Turn.Right, Turn.Right, Turn.Left), BoatAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Right, Turn.Right, Turn.Left, Turn.Left), BoatAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Right, Turn.Right, Turn.Left, Turn.Left, Turn.Left), BoatAnticlockwise);
                map.Add(new Key(Turn.Left, Turn.Left, Turn.Right, Turn.Right, Turn.Right, Turn.Right), BoatClockwise);
                map.Add(new Key(Turn.Left, Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Left), BoatClockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Right, Turn.Right, Turn.Left, Turn.Left), BoatClockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Right, Turn.Left, Turn.Left, Turn.Right), BoatClockwise);
                map.Add(new Key(Turn.Right, Turn.Right, Turn.Left, Turn.Left, Turn.Right, Turn.Right), BoatClockwise);
                map.Add(new Key(Turn.Right, Turn.Left, Turn.Left, Turn.Right, Turn.Right, Turn.Right), BoatClockwise);
            }
