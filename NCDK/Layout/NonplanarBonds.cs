...
namespace NCDK.Layout {
    ...
    sealed class NonplanarBonds {
         ...
         * @throws ArgumentException an atom had no 2D coordinates or labels could not be
         ...
         * @throws ArgumentException the labels could not be assigned
         */
