...
namespace NCDK.RingSearches
{
    ...
    public class JumboCyclicVertexSearchTest
    {
        ...
        {
            BitArray s = new BitArray(7);
            s.Set(0, true);
            s.Set(6, true);
            Assert.IsTrue(Compares.AreDeepEqual(new int[] { 0, 6 }, JumboCyclicVertexSearch.ToArray(s)));
        }
        ...
        {
            BitArray s = new BitArray(3);
            BitArray t = new BitArray(3);
            ...
            BitArray u = JumboCyclicVertexSearch.Xor(s, t);
        ...
        public virtual void TestAnd()
        {
            ...
            BitArray u = JumboCyclicVertexSearch.And(s, t);
        ...
        {
            BitArray set = new BitArray(7);
            set.Set(5, true);
            BitArray cpy = JumboCyclicVertexSearch.Copy(set);
            Assert.IsTrue(cpy[5]);
            set.Set(6, true);
            Assert.IsFalse(cpy[6]);
        }
    }
}
