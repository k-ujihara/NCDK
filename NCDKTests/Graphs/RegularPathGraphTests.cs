...
{
    [TestClass()]
    public class RegularPathGraphTests
    {
        // RegularPathGraph
        static PrivateObject NewPathGraph(int[][] mGraph, int[] rank, int limit)
            => new PrivateObject("NCDK", "NCDK.Graphs.RegularPathGraph", mGraph, rank, limit);
        // RegularPathGraph.SimpleEdge
        static PrivateObject NewSimpleEdge(int u, int v)
            => new PrivateObject("NCDK", "NCDK.Graphs.RegularPathGraph+SimpleEdge", u, v);
        ...
        static PrivateObject NewReducedEdge(PrivateObject e, PrivateObject f, int x)
            => new PrivateObject("NCDK", "NCDK.Graphs.RegularPathGraph+ReducedEdge", e.Target, f.Target, x);
