...
namespace NCDK.Graphs
{
    ...
    public class CyclesTest
    {
        ...
        {
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeBiphenyl()), 2);
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeBicycloRings()), 3);
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeNaphthalene()), 3);
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeAnthracene()), 6);
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeCyclophaneLike()), 135);
            CheckSize(Cycles.FindAllOrVertexShort().Find(MakeGappedCyclophaneLike()), 135);
            CheckSize(Cycles.FindAllOrVertexShort().Find(GetFullerene()), 120);
        }
        ...
        {
            CheckSize(Cycles.FindAllOrVertexShort()
                    .Find(MakeBiphenyl(), GraphUtil.ToAdjList(MakeBiphenyl()), int.MaxValue), 2);
            CheckSize(
                    Cycles.FindAllOrVertexShort().Find(MakeBicycloRings(), GraphUtil.ToAdjList(MakeBicycloRings()),
                            int.MaxValue), 3);
            CheckSize(
                    Cycles.FindAllOrVertexShort().Find(MakeNaphthalene(), GraphUtil.ToAdjList(MakeNaphthalene()),
                            int.MaxValue), 3);
            CheckSize(
                    Cycles.FindAllOrVertexShort().Find(MakeAnthracene(), GraphUtil.ToAdjList(MakeAnthracene()),
                            int.MaxValue), 6);
            CheckSize(
                    Cycles.FindAllOrVertexShort().Find(MakeCyclophaneLike(), GraphUtil.ToAdjList(MakeCyclophaneLike()),
                            int.MaxValue), 135);
            CheckSize(
                    Cycles.FindAllOrVertexShort().Find(MakeGappedCyclophaneLike(),
                            GraphUtil.ToAdjList(MakeGappedCyclophaneLike()), int.MaxValue), 135);
            CheckSize(Cycles.FindAllOrVertexShort().Find(GetFullerene(), GraphUtil.ToAdjList(GetFullerene()), int.MaxValue), 120);
        }

        [TestMethod()]
        public virtual void AllUpToLength()
        {
            CheckSize(Cycles.All(6).Find(MakeBiphenyl(), GraphUtil.ToAdjList(MakeBiphenyl()), int.MaxValue), 2);
            CheckSize(Cycles.All(6).Find(MakeBicycloRings(), GraphUtil.ToAdjList(MakeBicycloRings()), int.MaxValue), 3);
            CheckSize(Cycles.All(6).Find(MakeNaphthalene(), GraphUtil.ToAdjList(MakeNaphthalene()), int.MaxValue), 2);
            CheckSize(Cycles.All(6).Find(MakeAnthracene(), GraphUtil.ToAdjList(MakeAnthracene()), int.MaxValue), 3);
        }
        ...
        public virtual void Unchorded()
        {
            ...
            CheckSize(Cycles.GetUnchorded(Cycles.All()).Find(container), 3);
        }
