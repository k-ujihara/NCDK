...
namespace NCDK.Tools.Manipulator
{
    ...
    public class MolecularFormulaManipulatorTest : CDKTestCase
    {
        ...
        {
            var mf = "C2H4";
            var atomContainer = MolecularFormulaManipulator.GetAtomContainer(mf, ChemObjectBuilder.Instance);
        ...
        public void TestGetAtomContainer_AddsAtomicNumbers()
        {
            ...
            {
                if (ChemicalElement.AtomicNumbers.C.Equals(atom.AtomicNumber))
                    Assert.AreEqual(6, atom.AtomicNumber.Value);
                else if (ChemicalElement.AtomicNumbers.H.Equals(atom.AtomicNumber))
