...
namespace NCDK.Tools.Manipulator
{
    ...
    public class AtomTypeManipulatorTest : CDKTestCase
    {
        ...
        public void TestConfigure_IAtom_IAtomType()
        {
            ...
            IAtomType atomType = new AtomType(ChemicalElement.C) { IsHydrogenBondAcceptor = true };
        ...
        {
            IAtom atom = new Atom(ChemicalElement.C) { ExactMass = 13.0 };
            IAtomType atomType = new AtomType(ChemicalElement.C) { ExactMass = 12.0 };
