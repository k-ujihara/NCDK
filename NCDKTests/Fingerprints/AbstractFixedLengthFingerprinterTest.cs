...
namespace NCDK.Fingerprints
{
    ...
    public abstract class AbstractFixedLengthFingerprinterTest : AbstractFingerprinterTest
    {
        ...
        public static IAtomContainer Bug706786_1()
        {
            ...
            mol.Atoms.Add(a11);
            IAtom a12 = builder.CreateAtom("H");
            mol.Atoms.Add(a12);
            IAtom a13 = builder.CreateAtom("C");
            mol.Atoms.Add(a13);
            IAtom a14 = builder.CreateAtom("O");
            mol.Atoms.Add(a14);
            IAtom a15 = builder.CreateAtom("H");
            mol.Atoms.Add(a15);
            IAtom a16 = builder.CreateAtom("C");
            mol.Atoms.Add(a16);
            IAtom a17 = builder.CreateAtom("O");
            mol.Atoms.Add(a17);
            ...
            a19.IsAromatic = true;
            mol.Atoms.Add(a19);
            IBond b1 = builder.CreateBond(a2, a1, BondOrder.Single);
            mol.Bonds.Add(b1);
            IBond b2 = builder.CreateBond(a3, a2, BondOrder.Double);
            mol.Bonds.Add(b2);
            IBond b3 = builder.CreateBond(a4, a2, BondOrder.Single);
            mol.Bonds.Add(b3);
            IBond b4 = builder.CreateBond(a5, a4, BondOrder.Double);
            b4.IsAromatic = true;
            mol.Bonds.Add(b4);
            IBond b5 = builder.CreateBond(a6, a5, BondOrder.Single);
            b5.IsAromatic = true;
            mol.Bonds.Add(b5);
            IBond b6 = builder.CreateBond(a7, a6, BondOrder.Double);
            b6.IsAromatic = true;
            mol.Bonds.Add(b6);
            IBond b7 = builder.CreateBond(a8, a7, BondOrder.Single);
            mol.Bonds.Add(b7);
            IBond b8 = builder.CreateBond(a9, a8, BondOrder.Single);
            mol.Bonds.Add(b8);
            IBond b9 = builder.CreateBond(a10, a9, BondOrder.Single);
            mol.Bonds.Add(b9);
            IBond b10 = builder.CreateBond(a11, a9, BondOrder.Single);
            mol.Bonds.Add(b10);
            IBond b11 = builder.CreateBond(a13, a12, BondOrder.Single);
            mol.Bonds.Add(b11);
            IBond b12 = builder.CreateBond(a13, a9, BondOrder.Single);
            mol.Bonds.Add(b12);
            IBond b13 = builder.CreateBond(a14, a13, BondOrder.Single);
            mol.Bonds.Add(b13);
            IBond b14 = builder.CreateBond(a16, a15, BondOrder.Single);
            mol.Bonds.Add(b14);
            IBond b15 = builder.CreateBond(a16, a13, BondOrder.Single);
            mol.Bonds.Add(b15);
            IBond b16 = builder.CreateBond(a16, a6, BondOrder.Single);
            mol.Bonds.Add(b16);
            IBond b17 = builder.CreateBond(a17, a16, BondOrder.Single);
            mol.Bonds.Add(b17);
            IBond b18 = builder.CreateBond(a18, a7, BondOrder.Single);
            b18.IsAromatic = true;
            mol.Bonds.Add(b18);
            IBond b19 = builder.CreateBond(a19, a18, BondOrder.Double);
            b19.IsAromatic = true;
            mol.Bonds.Add(b19);
            IBond b20 = builder.CreateBond(a19, a4, BondOrder.Single);
            b20.IsAromatic = true;
            mol.Bonds.Add(b20);
            return mol;
        }
        ...
        public static IAtomContainer Bug706786_2()
        {
            ...
            IBond b1 = builder.CreateBond(a2, a1, BondOrder.Single);
            mol.Bonds.Add(b1);
            IBond b2 = builder.CreateBond(a3, a2, BondOrder.Single);
            mol.Bonds.Add(b2);
            IBond b3 = builder.CreateBond(a4, a3, BondOrder.Single);
            mol.Bonds.Add(b3);
            IBond b4 = builder.CreateBond(a5, a4, BondOrder.Double);
            b4.IsAromatic = true;
            mol.Bonds.Add(b4);
            ...
            b7.IsAromatic = true;
            mol.Bonds.Add(b7);
            IBond b8 = builder.CreateBond(a9, a8, BondOrder.Double);
            b8.IsAromatic = true;
            mol.Bonds.Add(b8);
            IBond b9 = builder.CreateBond(a9, a4, BondOrder.Single);
            b9.IsAromatic = true;
            mol.Bonds.Add(b9);
            IBond b10 = builder.CreateBond(a10, a9, BondOrder.Single);
            mol.Bonds.Add(b10);
            IBond b11 = builder.CreateBond(a10, a1, BondOrder.Single);
            mol.Bonds.Add(b11);
            return mol;
        }
        ...
        public static IAtomContainer Bug934819_1()
        {
            ...
            b7.IsAromatic = true;
            mol.Bonds.Add(b7);
            IBond b8 = builder.CreateBond(a8, a4, BondOrder.Single);
            b8.IsAromatic = true;
            mol.Bonds.Add(b8);
            return mol;
        }
        ...
        public static IAtomContainer Bug934819_2()
        {
            ...
            a9.IsAromatic = true;
            mol.Atoms.Add(a9);
            IAtom a10 = builder.CreateAtom("S");
            a10.IsAromatic = true;
            mol.Atoms.Add(a10);
            IAtom a11 = builder.CreateAtom("C");
            mol.Atoms.Add(a11);
            ...
            a16.IsAromatic = true;
            mol.Atoms.Add(a16);
            IAtom a17 = builder.CreateAtom("S");
            a17.IsAromatic = true;
            mol.Atoms.Add(a17);
            IAtom a18 = builder.CreateAtom("N");
            a18.FormalCharge = 1;
            mol.Atoms.Add(a18);
            IAtom a19 = builder.CreateAtom("O");
            a19.FormalCharge = -1;
            mol.Atoms.Add(a19);
            IAtom a20 = builder.CreateAtom("O");
            mol.Atoms.Add(a20);
            IBond b1 = builder.CreateBond(a2, a1, BondOrder.Single);
            mol.Bonds.Add(b1);
            IBond b2 = builder.CreateBond(a3, a2, BondOrder.Single);
            ...
            IBond b3 = builder.CreateBond(a4, a3, BondOrder.Single);
            mol.Bonds.Add(b3);
            IBond b4 = builder.CreateBond(a5, a4, BondOrder.Single);
            mol.Bonds.Add(b4);
            IBond b5 = builder.CreateBond(a6, a5, BondOrder.Single);
            mol.Bonds.Add(b5);
            IBond b6 = builder.CreateBond(a7, a6, BondOrder.Double);
            ...
            b9.IsAromatic = true;
            mol.Bonds.Add(b9);
            IBond b10 = builder.CreateBond(a10, a6, BondOrder.Single);
            b10.IsAromatic = true;
            mol.Bonds.Add(b10);
            IBond b11 = builder.CreateBond(a11, a9, BondOrder.Single);
            mol.Bonds.Add(b11);
            IBond b12 = builder.CreateBond(a12, a11, BondOrder.Triple);
            mol.Bonds.Add(b12);
            IBond b13 = builder.CreateBond(a13, a12, BondOrder.Single);
            mol.Bonds.Add(b13);
            IBond b14 = builder.CreateBond(a14, a13, BondOrder.Double);
            b14.IsAromatic = true;
            mol.Bonds.Add(b14);
            IBond b15 = builder.CreateBond(a15, a14, BondOrder.Single);
            b15.IsAromatic = true;
            mol.Bonds.Add(b15);
            IBond b16 = builder.CreateBond(a16, a15, BondOrder.Double);
            b16.IsAromatic = true;
            mol.Bonds.Add(b16);
            IBond b17 = builder.CreateBond(a17, a16, BondOrder.Single);
            b17.IsAromatic = true;
            mol.Bonds.Add(b17);
            IBond b18 = builder.CreateBond(a17, a13, BondOrder.Single);
            b18.IsAromatic = true;
            mol.Bonds.Add(b18);
            IBond b19 = builder.CreateBond(a18, a16, BondOrder.Single);
            mol.Bonds.Add(b19);
            IBond b20 = builder.CreateBond(a19, a18, BondOrder.Single);
            mol.Bonds.Add(b20);
            IBond b21 = builder.CreateBond(a20, a18, BondOrder.Double);
            mol.Bonds.Add(b21);
            return mol;
        }
