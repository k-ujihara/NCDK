...
namespace NCDK.Geometries.CIP
{
    ...
    {
        static readonly SmilesParser smiles = new SmilesParser(Silent.ChemObjectBuilder.Instance);
        ...
        [TestMethod()]
        public void TestTwoVersusDoubleBondedOxygen_R()
        {
        ...
        [TestMethod()]
        public void TestTwoVersusDoubleBondedOxygen_S()
        {
            IAtomContainer molecule = smiles.ParseSmiles("OC(O)C([H])(C)C=O");
