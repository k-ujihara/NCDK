...
namespace NCDK.Reactions.Mechanisms
{
    ...
    [TestClass()]
    public class RearrangementChargeMechanismTest : ReactionMechanismTest
    {
        public RearrangementChargeMechanismTest()
            : base()
        {
            SetMechanism(typeof(RearrangementChargeMechanism));
        }

        [TestMethod()]
        public void TestRearrangementChargeMechanism()
        {
            var mechanism = new RearrangementChargeMechanism();
