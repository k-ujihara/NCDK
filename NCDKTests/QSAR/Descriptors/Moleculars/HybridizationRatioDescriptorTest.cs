...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class HybridizationRatioDescriptorTest : MolecularDescriptorTest
    {
        ...
        public void TestHybRatioDescriptor1()
        {
            ...
            Assert.AreEqual(1.0, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.1);
        }
        ...
        public void TestHybRatioDescriptor2()
        {
            ...
            Assert.AreEqual(0.0, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.1);
        }
        ...
        public void TestHybRatioDescriptor3()
        {
            ...
            Assert.AreEqual(double.NaN, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value);
        }
    }
}
