...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class TPSADescriptorTest : MolecularDescriptorTest
    {
        ...
        public void TestTPSA1()
        {
            ...
            Assert.AreEqual(37.29, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.01);
        }
        ...
        public void TestTPSA2()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(39.39, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.01);
        }
        ...
        public void TestTPSA3()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(45.82, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.01);
        }
        ...
        public void TestTPSA4()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(28.632, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.01);
        }
        ...
        public void TestTPSA5()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(12.892, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.01);
        }
        ...
        public void TestTPSA6()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(16.61, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.1); //at:  16
        }
        ...
        public void TestTPSA7()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(0.0, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.1); //at:  16
        }
        ...
        public void TestTPSA8()
        {
            ...
            AddExplicitHydrogens(mol);
            Assert.AreEqual(40.45, ((DoubleResult)Descriptor.Calculate(mol).GetValue()).Value, 0.1); //at:  16
        }
