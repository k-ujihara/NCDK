...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class XLogPDescriptorTest : MolecularDescriptorTest
    {
        ...
        public void Testno688()
        {
            ...
            Assert.AreEqual(-1.69, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno1596()
        {
            ...
            Assert.AreEqual(0.86, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Testno367()
        {
            ...
            Assert.AreEqual(-3.30, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno1837()
        {
            ...
            Assert.AreEqual(-1.19, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno87()
        {
            ...
            Assert.AreEqual(7.00, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno1782()
        {
            ...
            Assert.AreEqual(1.84, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno937()
        {
            ...
            Assert.AreEqual(0.66, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno990()
        {
            ...
            Assert.AreEqual(1.834, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Testno1000()
        {
            ...
            Assert.AreEqual(2.809, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void TestApirinBug1296383()
        {
            ...
            Assert.AreEqual(1.422, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
        ...
        public void Testno1429()
        {
            ...
            Assert.AreEqual(0.31, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Testno1274()
        {
            ...
            Assert.AreEqual(-1.487, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void TestAprindine()
        {
            ...
            Assert.AreEqual(5.03, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Test1844()
        {
            ...
            Assert.AreEqual(5.22, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Test1810()
        {
            ...
            Assert.AreEqual(4.56, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 1.0); //at:  16
        }
        ...
        public void Test1822()
        {
            ...
            Assert.AreEqual(2.36, ((Result<double>)Descriptor.Calculate(mol).Value).Value, 0.1); //at:  16
        }
