...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    {
        public XLogPDescriptor CreateDescriptor(IAtomContainer container, bool checkAromaticity) => new XLogPDescriptor(container, checkAromaticity);
        ...
        public void Testno688()
        {
            ...
            Assert.AreEqual(-1.69, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno1596()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(0.86, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Testno367()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(-3.30, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno1837()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(-1.19, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno87()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(7.00, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno1782()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(1.84, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno30()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(4.62, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno937()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(0.66, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno990()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(1.834, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Testno1000()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(2.809, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void TestApirinBug1296383()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(1.422, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno1429()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(0.31, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Testno1274()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(-1.487, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Testno454()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(-2.11, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void Testno498()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(-0.59, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void TestAprindine()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(5.03, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Test1844()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(5.22, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Test1810()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(4.56, CreateDescriptor(mol, true).Calculate(false).Value, 1.0); //at:  16
        }
        ...
        public void Test1822()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(2.36, CreateDescriptor(mol, true).Calculate(false).Value, 0.1); //at:  16
        }
        ...
        public void TestAromaticBenzene()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(2.02, CreateDescriptor(mol, false).Calculate(true).Value, 0.01);
        }
        ...
        public void TestNonAromaticBenzene()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(2.08, CreateDescriptor(mol, false).Calculate(true).Value, 0.01);
        }
        ...
        public void TestPerceivedAromaticBenzene()
        {
            ...
            AssertAtomTypesPerceived(mol);
            AddExplicitHydrogens(mol);
            Assert.AreEqual(2.02, CreateDescriptor(mol, true).Calculate(true).Value, 0.01);
        }
    }
}
