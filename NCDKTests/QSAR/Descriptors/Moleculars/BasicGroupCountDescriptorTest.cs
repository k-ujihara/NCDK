...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class BasicGroupCountDescriptorTest : MolecularDescriptorTest
    {
        ...
        public void Test()
        {
            ...
            mol.Bonds.Add(b2);
            IBond b3 = builder.CreateBond(a2, a3, BondOrder.Double);
            mol.Bonds.Add(b3);
            IBond b4 = builder.CreateBond(a2, a8, BondOrder.Single);
            mol.Bonds.Add(b4);
            IBond b5 = builder.CreateBond(a3, a5, BondOrder.Single);
            mol.Bonds.Add(b5);
