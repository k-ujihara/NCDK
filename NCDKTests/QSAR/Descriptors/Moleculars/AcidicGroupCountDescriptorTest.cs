...
namespace NCDK.QSAR.Descriptors.Moleculars
{
    ...
    public class AcidicGroupCountDescriptorTest : MolecularDescriptorTest
    {
        ...
        public void TestTwoGroup()
        {
            ...
            mol.Atoms.Add(a10);
            IBond b1 = mol.Builder.CreateBond(a1, a8, BondOrder.Single);
            mol.Bonds.Add(b1);
            IBond b2 = mol.Builder.CreateBond(a1, a10, BondOrder.Single);
            mol.Bonds.Add(b2);
            IBond b3 = mol.Builder.CreateBond(a2, a8, BondOrder.Double);
            mol.Bonds.Add(b3);
            IBond b4 = mol.Builder.CreateBond(a3, a4, BondOrder.Single);
            mol.Bonds.Add(b4);
            IBond b5 = mol.Builder.CreateBond(a3, a7, BondOrder.Double);
            mol.Bonds.Add(b5);
            IBond b6 = mol.Builder.CreateBond(a4, a6, BondOrder.Single);
            mol.Bonds.Add(b6);
            IBond b7 = mol.Builder.CreateBond(a4, a9, BondOrder.Single);
            mol.Bonds.Add(b7);
            IBond b8 = mol.Builder.CreateBond(a5, a6, BondOrder.Double);
            mol.Bonds.Add(b8);
            IBond b9 = mol.Builder.CreateBond(a5, a7, BondOrder.Single);
            mol.Bonds.Add(b9);
            IBond b10 = mol.Builder.CreateBond(a7, a8, BondOrder.Single);
            mol.Bonds.Add(b10);
        ...
        public void TestCID()
        {
            ...
            mol.Atoms.Add(a5);
            IAtom a6 = mol.Builder.CreateAtom("O");
            a6.FormalCharge = 0;
            a6.Point2D = new Vector2(4.269, 1.25);
            mol.Atoms.Add(a6);
            IAtom a7 = mol.Builder.CreateAtom("O");
            a7.FormalCharge = 0;
            ...
            mol.Atoms.Add(a8);
            IAtom a9 = mol.Builder.CreateAtom("O");
            a9.FormalCharge = 0;
            a9.Point2D = new Vector2(10.3312, 0.75);
            mol.Atoms.Add(a9);
            IAtom a10 = mol.Builder.CreateAtom("O");
            a10.FormalCharge = 0;
            a10.Point2D = new Vector2(9.9651, -0.616);
            mol.Atoms.Add(a10);
            IAtom a11 = mol.Builder.CreateAtom("O");
            a11.FormalCharge = 0;
            ...
            mol.Atoms.Add(a14);
            IAtom a15 = mol.Builder.CreateAtom("C");
            a15.FormalCharge = 0;
            ...
            mol.Atoms.Add(a20);
            IAtom a21 = mol.Builder.CreateAtom("H");
            a21.FormalCharge = 0;
            a21.Point2D = new Vector2(4.8059, 0.56);
            mol.Atoms.Add(a21);
            IAtom a22 = mol.Builder.CreateAtom("H");
            a22.FormalCharge = 0;
            a22.Point2D = new Vector2(8.1316, 0.7249);
            mol.Atoms.Add(a22);
            IAtom a23 = mol.Builder.CreateAtom("H");
            a23.FormalCharge = 0;
            a23.Point2D = new Vector2(7.3346, 0.7249);
            mol.Atoms.Add(a23);
            IAtom a24 = mol.Builder.CreateAtom("H");
            a24.FormalCharge = 0;
            a24.Point2D = new Vector2(6.538, 1.56);
            mol.Atoms.Add(a24);
            IAtom a25 = mol.Builder.CreateAtom("H");
            a25.FormalCharge = 0;
            a25.Point2D = new Vector2(4.5981, -1.56);
            mol.Atoms.Add(a25);
            IAtom a26 = mol.Builder.CreateAtom("H");
            a26.FormalCharge = 0;
            a26.Point2D = new Vector2(7.404, -1.56);
            mol.Atoms.Add(a26);
            IAtom a27 = mol.Builder.CreateAtom("H");
            a27.FormalCharge = 0;
            a27.Point2D = new Vector2(3.732, 1.56);
            mol.Atoms.Add(a27);
            IAtom a28 = mol.Builder.CreateAtom("H");
            a28.FormalCharge = 0;
            a28.Point2D = new Vector2(2.0, -0.06);
            mol.Atoms.Add(a28);
            IAtom a29 = mol.Builder.CreateAtom("H");
            a29.FormalCharge = 0;
            a29.Point2D = new Vector2(10.8681, 0.44);
            mol.Atoms.Add(a29);
            IBond b1 = mol.Builder.CreateBond(a1, a5, BondOrder.Single);
            mol.Bonds.Add(b1);
            IBond b2 = mol.Builder.CreateBond(a1, a9, BondOrder.Single);
            mol.Bonds.Add(b2);
            IBond b3 = mol.Builder.CreateBond(a1, a10, BondOrder.Double);
            mol.Bonds.Add(b3);
            IBond b4 = mol.Builder.CreateBond(a1, a11, BondOrder.Double);
            mol.Bonds.Add(b4);
            IBond b5 = mol.Builder.CreateBond(a2, a12, BondOrder.Single);
            mol.Bonds.Add(b5);
            IBond b6 = mol.Builder.CreateBond(a2, a24, BondOrder.Single);
            mol.Bonds.Add(b6);
            IBond b7 = mol.Builder.CreateBond(a3, a13, BondOrder.Single);
            mol.Bonds.Add(b7);
            IBond b8 = mol.Builder.CreateBond(a3, a25, BondOrder.Single);
            mol.Bonds.Add(b8);
            IBond b9 = mol.Builder.CreateBond(a4, a14, BondOrder.Single);
            mol.Bonds.Add(b9);
            IBond b10 = mol.Builder.CreateBond(a4, a26, BondOrder.Single);
            mol.Bonds.Add(b10);
            IBond b11 = mol.Builder.CreateBond(a5, a16, BondOrder.Single);
            mol.Bonds.Add(b11);
            IBond b12 = mol.Builder.CreateBond(a6, a15, BondOrder.Single);
            mol.Bonds.Add(b12);
            IBond b13 = mol.Builder.CreateBond(a6, a27, BondOrder.Single);
            mol.Bonds.Add(b13);
            IBond b14 = mol.Builder.CreateBond(a7, a17, BondOrder.Single);
            mol.Bonds.Add(b14);
            IBond b15 = mol.Builder.CreateBond(a7, a28, BondOrder.Single);
            mol.Bonds.Add(b15);
            IBond b16 = mol.Builder.CreateBond(a8, a17, BondOrder.Double);
            mol.Bonds.Add(b16);
            IBond b17 = mol.Builder.CreateBond(a9, a29, BondOrder.Single);
            mol.Bonds.Add(b17);
            IBond b18 = mol.Builder.CreateBond(a12, a13, BondOrder.Single);
            mol.Bonds.Add(b18);
            IBond b19 = mol.Builder.CreateBond(a12, a14, BondOrder.Single);
            mol.Bonds.Add(b19);
            IBond b20 = mol.Builder.CreateBond(a12, a18, BondOrder.Single);
            mol.Bonds.Add(b20);
            IBond b21 = mol.Builder.CreateBond(a13, a15, BondOrder.Single);
            mol.Bonds.Add(b21);
            IBond b22 = mol.Builder.CreateBond(a13, a19, BondOrder.Single);
            mol.Bonds.Add(b22);
            IBond b23 = mol.Builder.CreateBond(a14, a16, BondOrder.Single);
            mol.Bonds.Add(b23);
            IBond b24 = mol.Builder.CreateBond(a14, a20, BondOrder.Single);
            mol.Bonds.Add(b24);
            IBond b25 = mol.Builder.CreateBond(a15, a17, BondOrder.Single);
            mol.Bonds.Add(b25);
            IBond b26 = mol.Builder.CreateBond(a15, a21, BondOrder.Single);
            mol.Bonds.Add(b26);
            IBond b27 = mol.Builder.CreateBond(a16, a22, BondOrder.Single);
            mol.Bonds.Add(b27);
            IBond b28 = mol.Builder.CreateBond(a16, a23, BondOrder.Single);
            mol.Bonds.Add(b28);
            AtomContainerManipulator.PercieveAtomTypesAndConfigureAtoms(mol);
            AddImplicitHydrogens(mol);
            IntegerResult result = (IntegerResult)Descriptor.Calculate(mol).GetValue();
