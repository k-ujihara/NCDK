    ...
    public class AtomHybridizationVSEPRDescriptorTest : AtomicDescriptorTest
    {
        ...
        public void TestAtomHybridizationVSEPRDescriptorTest_1()
        {
            ...
            Assert.AreEqual(Hybridization.SP2.Ordinal,
                    ((IntegerResult)descriptor.Calculate(molecule.Atoms[0], molecule).GetValue()).Value);
            Assert.AreEqual(Hybridization.SP2.Ordinal,
                    ((IntegerResult)descriptor.Calculate(molecule.Atoms[1], molecule).GetValue()).Value);
        ...
        public void TestAtomHybridizationVSEPRDescriptorTest_7()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                Assert.AreEqual(testResult[i],
                        ((IntegerResult)descriptor.Calculate(mol.Atoms[i], mol).GetValue()).Value);
            }
        }
        ...
        {
            int[] testResult = {Hybridization.SP2.Ordinal, Hybridization.SP2.Ordinal,
                Hybridization.SP3.Ordinal};
