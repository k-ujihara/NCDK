...
namespace NCDK.QSAR.Descriptors.Atomic
{
    ...
    public class AtomHybridizationDescriptorTest : AtomicDescriptorTest
    {
        ...
        public void TestAtomHybridizationDescriptorTest()
        {
            ...
            {
                Assert.AreEqual(expectedStates[i].Ordinal, ((IntegerResult)descriptor.Calculate(mol.Atoms[i], mol).GetValue()).Value);
            }
        }
        ...
        public void TestBug1701073()
        {
            ...
            foreach (var smile in smiles)
            {
                ...
                {
                    var dummy = ((IntegerResult)descriptor.Calculate(atom, mol).GetValue()).Value;
                }
            }
        }
    }
