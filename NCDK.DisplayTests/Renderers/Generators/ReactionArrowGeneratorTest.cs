...
namespace NCDK.Renderers.Generators
{
    ...
    [TestClass()]
    public class ReactionArrowGeneratorTest : AbstractGeneratorTest<IReaction>
    {
        private ReactionArrowGenerator generator;
        ...
        public ReactionArrowGeneratorTest()
            : base()
        {
        ...
        {
            var singleReaction = base.builder.NewReaction();
