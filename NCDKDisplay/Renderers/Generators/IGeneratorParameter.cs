...
namespace NCDK.Renderers.Generators
{
    ...
    /// not of atomic properties, rendering a circles for aromatic rings, etc.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    // @cdk.module  render
    // @cdk.githash
    public interface IGeneratorParameter<T> : IGeneratorParameter 
    {
        /// <summary>
        ...
        /// <summary>
        /// The default value for this parameter. This value is set by the parameter class and cannot be changed.
        /// </summary>
        T Default { get; }
    }
}
